...
async function main() {
	...
	// const tokenContract = await ethers.getContractFactory('BananaToken');
	// const tokenContractDeployer = await tokenContract.deploy();
	// console.log('myWalletDeployer :', tokenContractDeployer.address);
	...
	// ec = await ethers.getContractFactory('Staking');
